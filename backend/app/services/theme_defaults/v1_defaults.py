...
LIGHT_THEME_DEFAULTS: Dict[str, Any] = {
    "primary_colors": {
        "PRIMARY": "#8B4513",
...
DARK_THEME_DEFAULTS: Dict[str, Any] = {
    "primary_colors": {
        "PRIMARY": "#E89B6C",
    ...
    # 以下配置与亮色主题相同
    "typography": LIGHT_THEME_DEFAULTS["typography"].copy(),
    "border_radius": LIGHT_THEME_DEFAULTS["border_radius"].copy(),
    "spacing": LIGHT_THEME_DEFAULTS["spacing"].copy(),
    "animation": LIGHT_THEME_DEFAULTS["animation"].copy(),
    "button_sizes": LIGHT_THEME_DEFAULTS["button_sizes"].copy(),
}
