...
export const NOVEL_DETAIL_TAB_ITEMS: readonly NovelDetailTabItem[] = [
  ...
  { id: 'outlines', label: '大纲', description: '管理章节大纲与分部大纲，按流程推进。', icon: Share },
            ...
            {NOVEL_DETAIL_TAB_ITEMS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`
                    group min-w-[9.5rem] rounded-[20px] border px-3.5 py-3 text-left transition-all duration-300 xl:min-w-0
                    ${isActive
                ...
                >
                  <div className="flex items-center gap-2 text-sm font-bold">
                    <Icon size={16} className={isActive ? 'text-white' : 'text-book-text-muted group-hover:text-book-primary'} />
                    {tab.label}
                  </div>
                </button>
              );
