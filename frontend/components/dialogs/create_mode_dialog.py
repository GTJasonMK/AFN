...
class CreateModeDialog(BaseDialog):
    """创作模式选择对话框
    ...
    def _setup_ui(self):
        ...
        # 标题
        self.title_label = QLabel("选择创作模式")
        ...
        self.ai_card = self._create_mode_card(
            title="AI辅助创作",
            description="通过灵感对话，让AI帮你构思故事框架、角色设定和情节走向",
            icon_text="AI",
            is_recommended=True
        )
        ...
        # 自由创作卡片
        self.free_card = self._create_mode_card(
            title="自由创作",
            description="跳过AI对话，直接手动填写蓝图、角色、章节大纲等所有内容",
            icon_text="FREE",
