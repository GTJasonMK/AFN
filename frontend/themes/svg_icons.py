...
class SVGIcons:
    ...
    @staticmethod
    def trash(size: int = 24, color: str = "currentColor") -> str:
        """🗑️ 删除/垃圾桶图标"""
        return f"""<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    @staticmethod
    def eye(size: int = 24, color: str = "currentColor") -> str:
        """👁️ 查看/眼睛图标"""
        return f"""<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    @staticmethod
    def play(size: int = 24, color: str = "currentColor") -> str:
        """▶️ 播放/继续图标"""
        return f"""<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5 3L19 12L5 21V3Z" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="{color}" fill-opacity="0.2"/>
        </svg>"""

    @staticmethod
    def edit(size: int = 24, color: str = "currentColor") -> str:
        """📝 编辑图标"""
        return f"""<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M18.5 2.5C18.8978 2.10217 19.4374 1.87868 20 1.87868C20.5626 1.87868 21.1022 2.10217 21.5 2.5C21.8978 2.89782 22.1213 3.43739 22.1213 4C22.1213 4.56261 21.8978 5.10217 21.5 5.5L12 15L8 16L9 12L18.5 2.5Z" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>"""
