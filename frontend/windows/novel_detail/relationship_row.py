...
class RelationshipRow(QFrame):
    ...
    def _apply_style(self):
        ...
        # 名字样式
        name_style = f"font-size: {sp(14)}px; font-weight: 600; color: {theme_manager.TEXT_PRIMARY}; background: transparent;"
        ...
        if hasattr(self, 'type_label'):
            self.type_label.setStyleSheet(
                f"font-size: {sp(12)}px; font-weight: 600; color: {theme_manager.PRIMARY}; "
