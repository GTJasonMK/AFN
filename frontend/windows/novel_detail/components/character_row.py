...
class CharacterRow(QFrame):
    ...
    def _apply_style(self):
        ...
        self.name_label.setStyleSheet(
            f"font-family: {self.ui_font}; font-size: {sp(15)}px; font-weight: 600; color: {theme_manager.TEXT_PRIMARY}; background: transparent;"
        )

        # 身份样式
        if hasattr(self, 'identity_label'):
            self.identity_label.setStyleSheet(
                f"font-family: {self.ui_font}; font-size: {sp(12)}px; color: {theme_manager.TEXT_TERTIARY}; "
